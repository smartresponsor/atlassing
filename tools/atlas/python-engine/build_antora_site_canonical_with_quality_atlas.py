...
"""Canonical builder replacement candidate with Quality Atlas integration.

This file is a candidate replacement for `tools/build_antora_site.py`.
It keeps the current canonical build path and adds:

1. Quality Atlas page generation into the Antora pages tree
2. Quality Atlas nav entry
3. Home-page summary block framed as pre-RC / before v1

Use it to validate the final integrated behavior before replacing the
current canonical builder file.
"""
