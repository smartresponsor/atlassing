...
<div class="qa-grid">
  <div class="qa-panel">
    ...
    <p style="font-size:12px;color:#66708a;margin-bottom:0;">Contracts live in <code>var/atlas/contract</code>. History lives in <code>var/atlas/component/*/history</code>.</p>
  </div>
  <div class="qa-main">
    <div class="qa-kpis">
...
This page is generated from canonical snapshot contracts stored under `var/atlas/component/*`.
