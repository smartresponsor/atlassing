...
COMPONENTS_DIR = ROOT / 'var' / 'atlas' / 'component'
GENERATED_DIR = ROOT / 'var' / 'atlas' / 'generated'
...
<div class=\"qas-grid\">
  <div class=\"qas-panel\">
    ...
    <p class=\"qas-meta\">Policy source: <code>var/atlas/schedule/assessment-policy.yaml</code></p>
    <p class=\"qas-meta\">Latest plan: <code>var/atlas/generated/selection-plan.json</code></p>
  </div>
  <div class=\"qas-main\">
    <div class=\"qas-kpis\">
...
This page is generated from `var/atlas/schedule/assessment-policy.yaml`, the repository registry, and the latest selection plan.
