...
CARDS_FILE = ROOT / 'var' / 'atlas' / 'card' / 'assessment-cards.yaml'
METRIC_CATALOG_FILE = ROOT / 'var' / 'atlas' / 'contract' / 'metric-catalog.yaml'
VIEW_PROFILES_FILE = ROOT / 'var' / 'atlas' / 'contract' / 'view-profiles.yaml'
SCORING_MODEL_FILE = ROOT / 'var' / 'atlas' / 'contract' / 'scoring-model.yaml'
ASSESSMENT_SCHEMA_FILE = ROOT / 'var' / 'atlas' / 'contract' / 'assessment-response-schema.yaml'
PROBE_FAMILIES_FILE = ROOT / 'var' / 'atlas' / 'contract' / 'probe-families.yaml'
OUTBOX_DIR = ROOT / 'var' / 'atlas' / 'generated' / 'assessment-runs'
LATEST_SUMMARY_FILE = ROOT / 'var' / 'atlas' / 'generated' / 'latest-assessment-summary.json'
...
def merge_snapshot(current: dict[str, Any] | None, component: dict[str, Any], verdict: dict[str, Any], probe_snapshot: dict[str, Any], run_label: str, origin: str, facts: dict[str, Any], selection_entry: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    probe_path = f"var/atlas/component/{component['component_id']}/probes/current.yaml"
